...
export default function Newsletter() {
  return (
    <section className="bg-primary/25">
      <div className="container gap-4 md:gap-5 lg:gap-6 mx-auto px-2 flex items-center justify-center flex-col h-[20rem] md:h-[25rem] text-center">
        ...
        <form className="flex items-center">
          <input
            ...
            type="text"
          />
          <button className="btn h-full rounded-br rounded-tr btn-primary rounded-none btn-sm">
            JOIN
          </button>
        </form>
